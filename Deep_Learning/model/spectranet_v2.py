...
DEFAULT_STREAM_CFG: Dict[str, Any] = {
    ...
    "stage2": {"block_type": "fused", "expand_ratio": 2, "out_channels": 56, "repeats": 4, "stride": 2, "use_se": False},
    "stage3": {"block_type": "mbconv", "expand_ratio": 4, "out_channels": 80, "repeats": 4, "stride": 1, "use_se": True},
    "stage4": {"block_type": "mbconv", "expand_ratio": 6, "out_channels": 88, "repeats": 6, "stride": 1, "use_se": True},
}
...
def build_spectranet_v2(input_shapes: Dict[str, Any] = None,
...
if __name__ == "__main__":
    ...
    model = build_spectranet_v2(input_shapes=input_shapes, cfg=DEFAULT_CFG, num_classes=15)
    model.summary()
